...
export class HomePage extends BasePage{
    constructor(page){
        ...
        this.searchDestination = page.locator("//input[@placeholder='Search the Destination']");
        this.popularDestinations = page.locator("//p[text()='Popular Destinations']/following-sibling::div//p[2]");
        this.travelTipsAdvice = page.locator("(//p[text()='Travel Tips and Advice']/following::div/following::p)[1]");
        this.travelTipsAuthor = this.travelTipsAdvice.locator("/following-sibling::div/div[2]/child::p");
    ...
    async displayedViewPackagesBtn(){
        await this.viewPackagesBtn.toBeVisible();
